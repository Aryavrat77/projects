...
namespace Image
{
	...
	public:
		...
		*** The variance of the Gaussian and the radius over which the weighted summation is performed are specified by the parameters. */
		...
		bool checkInBounds(int x, int y) const; 

		/*
		* helper method that computes the x coordinate of the image that maps to the swirl image.
		*/		
		int coordinate_x(int x, int y, int cx, int cy, double alpha) const; 

		/*
		* helper method that computes the y coordinate of the image that maps to the swirl image.
		*/
		int coordinate_y(int x, int y, int cx, int cy, double alpha) const;

		/*
		* helper method that computes the alpha value based on coordinates (x,y), and center values (cx,cy), swirl parameter s.
		*/
		double swirl_helper(int x, int y, int cx, int cy, double s) const;
