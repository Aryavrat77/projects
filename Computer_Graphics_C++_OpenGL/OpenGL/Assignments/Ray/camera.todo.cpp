...
void Camera::drawOpenGL( void ) const
{
    ...
    // Convert heightAngle from degrees to radians
    double fov = heightAngle * (180.0 / M_PI);

	// Declare variables to store the viewport dimensions
    ...
    // Assuming you have a camera position, target, and up vector
    gluLookAt(
