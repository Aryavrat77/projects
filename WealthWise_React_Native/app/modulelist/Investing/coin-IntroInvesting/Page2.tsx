...
const Page2: React.FC = () => {
  ...
  const navigateToNextPage = () => {
    router.push(`/modulelist/Investing/coin-IntroInvesting/Quiz1`);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.text}>Investing is when you use your money to buy things that can make more money for you. It's different from saving because, with investing, your money has the chance to grow over time.</Text>
      </View>
